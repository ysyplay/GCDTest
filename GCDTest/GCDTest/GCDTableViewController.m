...
- (void)viewDidLoad {
    ...
    self.dataProvider =  @[@{@"title" : @"队列",@"children":@[@{@"title" : @"串行队列",@"children":@"",@"selector":@"testSerialqueue"},
                           ...
                           @{@"title" : @"GCD其它常用API",@"children":@[
                                     ...
                                     @{@"title" : @"dispatch_set_target_queue2",@"children":@"",@"selector":@"testTargetQueue2"},
                                     ...
                                     @{@"title" : @"dispatch_group2",@"children":@"",@"selector":@"dispatch_group2"},
                                     ...
                                     @{@"title" : @"定时器",@"children":@"",@"selector":@"timerRun"},]},
                           ];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    vc.title =  [arr[indexPath.row] objectForKey:@"title"];
